...
* **Powerfull table enhanced by DataTables.js for fast and easy administration of Birthdays Records**
* **3 different modes: List (with User's Image), Calendar for all year Birthdays, Upcoming Birthdays, Default comma seperated Birthdays of current day
